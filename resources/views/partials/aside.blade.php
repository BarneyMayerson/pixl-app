    ...
    <ol class="mt-4 flex flex-col gap-4">
      <li class="flex items-center justify-between gap-4">
        <div class="flex items-center gap-2.5">
          <img src="/storage/images/alessia.png" alt="Avatar of Alessia" class="size-8 object-cover" />
      ...
      <li class="flex items-center justify-between gap-4">
        <div class="flex items-center gap-2.5">
          <img src="/storage/images/anne.png" alt="Avatar of Anne" class="size-8 object-cover" />
      ...
      <li class="flex items-center justify-between gap-4">
        <div class="flex items-center gap-2.5">
          <img src="/storage/images/mr-anderson.png" alt="Avatar of Mr. Anderson" class="size-8 object-cover" />
      ...
      <li class="flex items-center justify-between gap-4">
        <div class="flex items-center gap-2.5">
          <img src="/storage/images/michael.png" alt="Avatar of Michael" class="size-8 object-cover" />
