<x-layout title="Profile | PIXL">
  ...
  <main class="-mx-4 flex grow flex-col gap-4 overflow-y-auto px-4 py-4">
    ...
    <!-- Profile header -->
    <header>
      <img src="/storage/images/cover.png" alt="" />
      <div class="-mt-10 flex flex-wrap items-end justify-between gap-4 md:-mt-16">
        <div class="flex items-end gap-4">
          <img src="/storage/images/adrian.png" alt="Avatar for Adrian" class="size-20 object-cover md:size-32" />
    ...
    <ol class="border-pixl-light/10 border-t pt-4">
      ...
      <li class="not-first:pt-2.5 flex items-start gap-4">
        <a href="/profile" class="shrink-0">
          <img src="/storage/images/michael.png" alt="Avatar for Michael" class="size-10 object-cover" />
        </a>
                  ...
                  <button aria-label="Share" class="hover:text-pixl">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" class="h-[17px]" viewBox="0 0 19 17">
                      <g fill="currentColor" clip-path="url(#a)">
                        ...
                        <path d="M12.75 2.125h-2.124V4.25h2.125V2.125Zm2.125 2.125H12.75v2.125h2.125V4.25Z" />
                        <path
          ...
          <ol>
            ...
            <li class="group/li relative flex items-start gap-4 pt-4">
              ...
              <a href="/profile" class="isolate shrink-0">
                <img src="/storage/images/simon-chilling.png" alt="Avatar for Simon" class="size-10 object-cover" />
              </a>
    ...
    <footer class="mt-30 ml-14">
      ...
      <!-- White noise -->
      <div class="h-20 bg-[url(/storage/images/white-noise.gif)]"></div>
    </footer>
  </main>
