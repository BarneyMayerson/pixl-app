  ...
  <button aria-label="Share" class="hover:text-pixl">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" class="h-4.25" viewBox="0 0 19 17">
      <g fill="currentColor" clip-path="url(#a)">
        ...
        <path d="M10.624 0H8.499v2.125h2.125V0Zm2.126 0h-2.124v2.125h2.125V0Zm2.125 2.125H12.75V4.25h2.125V2.125Z" />
        ...
        <path d="M6.373 14.875H4.248V17h2.125v-2.125Zm2.127 0H6.375V17H8.5v-2.125Zm4.25 0h-2.124V17h2.125v-2.125Z" />
