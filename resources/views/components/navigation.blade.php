<header class="my-4 hidden w-48 shrink-0 flex-col justify-between gap-8 pl-4 sm:flex xl:ml-32">
  <div class="overflow-y-auto">
    ...
    <a href="/">
      <svg class="h-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 182 61" fill="none">
        ...
        <path fill="#EEE" d="M151.249 0h-10.083v10.083h10.083V0Zm0 10.084h-10.083v10.083h10.083V10.083Z"></path>
        <path fill="#EEE"
  ...
  <div class="flex gap-3.5">
    <a href="/profile" class="shrink-0">
      <img src="/storage/images/adrian.png" alt="Avatar for Adrian" class="size-11 object-cover" />
    </a>
